...
Route::prefix('admin')->middleware(['auth',IsAdmin::class])->name('admin.')->group( function () {
   ...
   // Route::resource('cuVerses', App\Http\Controllers\Admin\CuVersesController::class);
    ...
    Route::get('cms/{project}', [App\Http\Controllers\Admin\CMSController::class,'show'])->name('cms.show');
    Route::post('cms/createpage', [App\Http\Controllers\Admin\CMSController::class,'createpage'])->name('cms.createpage');
    Route::get('cms/list/{project}', [App\Http\Controllers\Admin\CMSController::class,'list'])->name('cms.list');
    Route::delete('cms/delete/{project}/{cuVerse?}', [App\Http\Controllers\Admin\CMSController::class,'delete'])->name('cms.delete');
    ...
    // Route::resource('projectAssets', App\Http\Controllers\Admin\ProjectAssetsController::class);
});