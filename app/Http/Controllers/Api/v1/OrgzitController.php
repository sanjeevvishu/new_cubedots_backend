         ...
         if($response->successful()){
            ...
            try {
                \Illuminate\Support\Facades\Mail::send([], [], function ($message) use ($inputs) {
                    ...
                    $message->subject("Schedule a Enrolment request" );
    ...
    public function requestEnrollment(Request $request)
    {
        ...
        $post_data = [
            ...
            'fields' => [
                ...
                'project_interest'   => !empty($inputs['project_interest']) ? $inputs['project_interest'] : 'NA',
                'source'    => 'CuEngine Portal'
            ],
            'use_field_slug' => true
        ];
    ...
    public function createAppointment(Request $request){
        ...
        $post_data = [
            ...
            'dbvalues' => [
                ...
                //'assign_to_2' => 'orxoqnvnhv',//$AssignToManagerVal
