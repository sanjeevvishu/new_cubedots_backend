...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('CMS') }} <a class="btn btn-sm btn-secondary"
                        href="{{ route('admin.cms.createpage') }}">Add New Content</a>
                </div>
                            ...
                            @forelse($cms as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.cms.edit',$row->id) }}" title="Edit">Edit</a>

                                        | <form method="post" class="delete_form"
                                            action="{{ route('admin.cms.destroy',$row->id) }}"
